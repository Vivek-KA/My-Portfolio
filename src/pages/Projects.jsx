  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-12 sm:mb-16">
        ...
        <div className="mx-auto mt-3 sm:mt-4 h-1 w-20 sm:w-24 rounded-full bg-gradient-to-r from-emerald-400 to-violet-500" />

        <p className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-gray-400 max-w-2xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-10">
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-gray-400 text-xs sm:text-sm mb-4">
              <FaCalendarAlt />
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-gray-300 space-y-1 mb-5">
            ...
            <div className="flex flex-wrap gap-2">
              {project.tech.map((tech, i) => (
                <span
                  key={i}
                  className={`px-3 py-1 text-xs sm:text-sm rounded-full border transition hover:scale-105 ${
                    techColors[tech] ||
